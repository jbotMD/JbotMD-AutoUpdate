...
<p align="center">
<a href="https://github.com/jbotXjisan"><img title="Author" src="https://img.shields.io/badge/AUTHOR-jbotXjisan-green.svg?style=for-the-badge&logo=github"></a>
...
- If you cant see the pairing code check [here](https://github.com/jbotXjisan/jbot-MD/issues/10)
---------
...
- Gak liat pairing code? [cek sini](https://github.com/jbotXjisan/jbot-MD/issues/10)
...
git clone https://github.com/jbotXjisan/jbot-MD
cd jbot-MD
npm install
npm update
```
...
```bash
git https://github.com/jbotXjisan/jbot-MD
cd jbot-MD
npm install
npm update
```
